...
def _open_dialog(monkeypatch, kind):
    ...
    monkeypatch.setattr(help_viewer.ttk, "Label", lambda *_a, **_k: mock.MagicMock())
    monkeypatch.setattr(help_viewer.ttk, "Entry", lambda *_a, **_k: mock.MagicMock())
