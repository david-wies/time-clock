...
def test_calculate_period_balance() -> None:
    ...
    # Create time records
    records = [
        TimeRecord(1, date(2026, 6, 22), time(9, 0), time(17, 0), 30, WorkType.REMOTE),  # Worked 7.5h (target 8.0)
        TimeRecord(2, date(2026, 6, 23), time(9, 0), time(18, 0), 0, WorkType.REMOTE),   # Worked 9.0h (target 8.0)
    ]
...
def test_calculate_period_balance_overtime_rate() -> None:
    ...
    records_surplus = [
        TimeRecord(1, date(2026, 6, 22), time(8, 0), time(18, 0), 0, WorkType.REMOTE),  # Worked 10h (target 8h)
    ]
    ...
    records_deficit = [
        TimeRecord(1, date(2026, 6, 22), time(9, 0), time(15, 0), 0, WorkType.REMOTE),  # Worked 6h (target 8h)
    ]
